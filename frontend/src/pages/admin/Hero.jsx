...
export default function Hero() {
	const { stats, hero_socialLinks } = localAPI;
	...
	return (
		...
		>
			<div id="Home" className="Hero_Section">
				...
				>
					See Your <br className="sm:hidden " /> Dream <br /> Home
					<br className="sm:hidden" /> in 3D
				</motion.h1>
				...
				>
					and turn it into reality with Us
				</motion.p>
					...
					<div className="flex w-full lg:justify-between small:justify-start justify-between gap-4 items-center">
						...
						<div className="flex w-full max-sm:justify-between items-center justify-start gap-4">
							{stats.map((stat, index) => (
								...
								>
									<h3 className="text-2xl md:text-3xl font-[500]">
										{stat.number}
									</h3>
									<p>{stat.name}</p>
								</motion.div>
